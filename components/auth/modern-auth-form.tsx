...
export function ModernAuthForm() {
  ...
  return (
    <div className="min-h-screen bg-aleo-gradient-light flex items-center justify-center p-4">
      {/* Background elements */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="glass-effect border-0 aleo-shadow">
          <CardHeader className="text-center pb-8">
            <div className="w-16 h-16 bg-aleo-gradient rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Wallet className="h-8 w-8 text-white" />
            </div>
            <CardTitle className="text-2xl font-bold">
              {preselectedRole
                ? `Join as ${preselectedRole === "freelancer" ? "Freelancer" : "Employee"}`
                : "Welcome to LeoPay"}
            </CardTitle>
            ...
            <Tabs defaultValue="email" className="w-full">
              ...
              <TabsContent value="email" className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-12 rounded-xl border-gray-200 focus:border-primary-300"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-3">
                  <Button
                    className="w-full h-12 bg-aleo-gradient hover:opacity-90 text-white font-semibold rounded-xl"
                  ...
                  <Button
                    variant="outline"
                    className="w-full h-12 border-2 border-gray-200 hover:border-primary-300 font-semibold rounded-xl bg-white/80"
